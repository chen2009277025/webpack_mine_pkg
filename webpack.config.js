...
var commonConfig = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.js$|\.jsx$/, exclude: /(node_modules|bower_components)/, loader: 'babel', query: { presets: ['es2015','react'] }, happy: {id: "js"} }
    ]
  },
  output: {
    path: BUILD_PATH,
...
module.exports = merge(commonConfig, {
  output: {
    publicPath: '//s3.meituan.net/v1/mss_c4375b35f5cb4e678b5b55a48c40cf9d/waimai-mfe-crm/',
    path: BUILD_PATH,
